...
- *Top-k-Retrieval Parameter*: Sie definiert, wie viele passende Chunks bei einer Abfrage vom #acr("RAG")-System zurückgegeben werden. Ein niedriger Wert kann relevante Ergebnisse ausschließen, während ein zu hoher Wert irrelevante Informationen #box("mit einbezieht. "+cite(<lewis2020rag>, supplement: "S. 2"))
